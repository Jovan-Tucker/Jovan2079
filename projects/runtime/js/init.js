var init = function (window) {
    ...
    var background = opspark.makeBackground(app, ground);//holds the background function and the backgrpund to the variable// 
view.addChild(background);
    ...
    var hud = opspark.makeHud();//calling the hud function and storing it//  
    view.addChild(hud);//adding the hud as a child to view//
    window.hud = hud;
